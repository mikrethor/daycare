INSERT INTO DAYCARE("ID", "NAME") VALUES ('uuid-daycare-uuid-1', 'Ma garderie');
...
('f13be1c0-9027-421f-8cf3-c3fdfa735a2a', 'John', 'Doe', '821f498d827d4edad2ed0960408a98edceb661d9f34287ceda2962417881231a', 'johndoe@daycare.com','uuid-daycare-uuid-1'),
('f13be1c0-9027-421f-8cf3-c3fdfa735a3a', 'Admin', 'Admin', '$2a$10$ZTl3Ct8F54qweI8ZBxJ7ce9wuE0u5ldgOvGpVBODphiCrT1ezl/9O', 'admin@daycare.com','uuid-daycare-uuid-1'),
('f13be1c0-9027-421f-8cf3-c3fdfa735a4a', 'Par', 'Ent', '821f498d827d4edad2ed0960408a98edceb661d9f34287ceda2962417881231a', 'parent@daycare.com','uuid-daycare-uuid-1'),
('f13be1c0-9027-421f-8cf3-c3fdfa735a5a', 'Test', 'Test', '821f498d827d4edad2ed0960408a98edceb661d9f34287ceda2962417881231a', 'test.test@test.com','uuid-daycare-uuid-1');
...
('f13be1c0-9027-421f-8cf3-c3fdfa735aaa', 'Arthur','B','uuid-daycare-uuid-1'),
('7654fe79-5b38-4738-a899-6c49a2a69d3c', 'Louis','B','uuid-daycare-uuid-1');

--Child 1
INSERT INTO SUMUP("ID", "ID_CHILD", "COMMENT", "MOOD", "APPETITE", "SLEEP", "DAY") VALUES
(1, 'f13be1c0-9027-421f-8cf3-c3fdfa735aaa','comment 1 a','BAD','MEDIUM','GOOD',CURRENT_DATE),
...
INSERT INTO NEED("ID","CODE") VALUES ('6ad2ef8b-f5d0-40e4-80ab-e6c0888c46cd','TEST');
