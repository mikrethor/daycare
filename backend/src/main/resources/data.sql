...
--Child 1
insert into SUMUP("ID", "ID_CHILD", "COMMENT", "MOOD", "APPETITE", "SLEEP", "DAY") values (1, 1,'comment 1','BAD','MEDIUM','GOOD',parsedatetime('26-12-2017 00:00:00.00', 'dd-MM-yyyy hh:mm:ss.SS') );
...
--Child 2
insert into SUMUP("ID", "ID_CHILD", "COMMENT", "MOOD", "APPETITE", "SLEEP", "DAY") values (11, 2,'comment 1','BAD','MEDIUM','GOOD',parsedatetime('26-12-2017 00:00:00.00.00', 'dd-MM-yyyy hh:mm:ss.SS'));
